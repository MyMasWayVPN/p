...
run_ei() {
  ...
  # Link izin IP VPS
  url_izin='https://raw.githubusercontent.com/MyMasWayVPN/mymaswayvpn.github.io/main/akses/ip/buyer/izin'
...
clear
      ...
      echo -e ""
      echo -e "\e[93m Telegram\e[32;1m : https://t.me/MyMasWayVPN"
      echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | lolcat
      echo -e ""
      exit 0
    fi
...
wget https://raw.githubusercontent.com/mymaswayvpn/p/main/menu.zip
unzip menu.zip
chmod +x *
rm -fr menu.zip
#######service
cd /etc/systemd/system
wget https://raw.githubusercontent.com/mymaswayvpn/p/main/service.zip
unzip service.zip
chmod +x *
rm -fr service.zip
#####core
cd /usr/local/bin
wget https://raw.githubusercontent.com/mymaswayvpn/p/main/ws.zip
unzip ws.zip
chmod +x *
rm -fr ws.zip
###slowdns
mkdir /etc/slowdns
cd /etc/slowdns
wget https://raw.githubusercontent.com/mymaswayvpn/p/main/dns.zip
unzip dns.zip
chmod +x *
...
wget -O /etc/nginx/conf.d/funnvpn.conf https://raw.githubusercontent.com/mymaswayvpn/p/main/funnvpn.conf
...
<font color="red"><b>********  MasWay VPN  ********</b></font><br>
<font color="blue"><b>===============================</br></font><br>
END
...
wget -O /etc/xray/config.json https://raw.githubusercontent.com/mymaswayvpn/p/main/config.json
